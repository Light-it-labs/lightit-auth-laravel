...
describe('two-factor screen stub rendering', function () use ($fixturePath, $stubPath): void {
    ...
    it('gives the OTP and recovery-code inputs an accessible name', function () use ($stubPath): void {
        $otp = (new StubRenderer)->render($stubPath('(public)/_guest/two-factor/page.tsx.stub'), FrontendStubTokens::defaults());
        $recoveryCode = (new StubRenderer)->render($stubPath('(public)/_guest/two-factor/recovery-code/page.tsx.stub'), FrontendStubTokens::defaults());
