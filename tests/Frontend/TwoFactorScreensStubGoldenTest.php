...
describe('two-factor screen stub rendering', function () use ($fixturePath, $stubPath): void {
    it('renders each screen byte-for-byte against its golden fixture', function (
        ...
        [
            '(public)/_guest/two-factor/-components/recovery-codes.tsx.stub',
            '(public)/_guest/two-factor/-components/recovery-codes.tsx',
        ],
    ...
    it(
        'never reads accessToken directly - every completed challenge goes through persistSession',
