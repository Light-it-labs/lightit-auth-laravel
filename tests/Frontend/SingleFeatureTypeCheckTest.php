...
describe(
    'single-feature type-check',
    function () use ($scaffoldProject, $copyFeatureFiles, $generateRouteTree, $typeCheck): void {
        ...
        it('type-checks a two-factor-authentication-only install on its own', function () use (
            $scaffoldProject,
            $copyFeatureFiles,
            $generateRouteTree,
            $typeCheck
